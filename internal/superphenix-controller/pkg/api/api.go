...
import (
	"net/http"
	"superphenix-controller/api"
	"superphenix-controller/pkg/api/authentication"
	configApi "superphenix-controller/pkg/api/config"
	"superphenix-controller/pkg/api/gc"
	"superphenix-controller/pkg/api/k8s"
	"superphenix-controller/pkg/api/kubeovn"
	"superphenix-controller/pkg/api/kubevirt"
	customMw "superphenix-controller/pkg/api/middleware"
	"superphenix-controller/pkg/api/paas"
