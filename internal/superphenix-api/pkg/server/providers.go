...
import (
	...
	adminAz "superphenix-api/pkg/services/admin/az"
	adminBilling "superphenix-api/pkg/services/admin/billing"
	adminPermission "superphenix-api/pkg/services/admin/permission"
	apiToken "superphenix-api/pkg/services/auth/apitoken"
	"superphenix-api/pkg/services/auth/session"
	argoApp "superphenix-api/pkg/services/controller/argo-app"
	baasctrl "superphenix-api/pkg/services/controller/baas"
	diskctrl "superphenix-api/pkg/services/controller/disk"
	eipctrl "superphenix-api/pkg/services/controller/eip"
	firewallctrl "superphenix-api/pkg/services/controller/firewall"
	instancectrl "superphenix-api/pkg/services/controller/instance"
	kaasctrl "superphenix-api/pkg/services/controller/kaas"
	loadbalancerctrl "superphenix-api/pkg/services/controller/loadbalancer"
	metadatactrl "superphenix-api/pkg/services/controller/metadata"
	snapshotctrl "superphenix-api/pkg/services/controller/snapshot"
	sshctrl "superphenix-api/pkg/services/controller/ssh"
	subnetctrl "superphenix-api/pkg/services/controller/subnet"
	vmsnapshotctrl "superphenix-api/pkg/services/controller/vmsnapshot"
	vpcctrl "superphenix-api/pkg/services/controller/vpc"
	"superphenix-api/pkg/services/iam/group"
	"superphenix-api/pkg/services/iam/membership"
	"superphenix-api/pkg/services/iam/organization"
	"superphenix-api/pkg/services/iam/permission"
	"superphenix-api/pkg/services/iam/user"
	"superphenix-api/pkg/services/project/manager"
	"superphenix-api/pkg/services/project/project"
	"superphenix-api/pkg/services/region/az"
