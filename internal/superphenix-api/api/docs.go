...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/superphenix-api_internal_db_model.Organization"
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/superphenix-api_internal_db_model.Product"
                            }
                        }
                    },
                    "404": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/superphenix-api_internal_db_model.Project"
                            }
                        }
                    },
                    "404": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/superphenix-api_internal_db_model.User"
                            }
                        }
                    },
                    "404": {
    ...
    "definitions": {
        ...
        "superphenix-api_internal_db_model.Organization": {
            "type": "object",
            "properties": {
                "administrativeContact": {
                    "type": "string"
                ...
                "userRoles": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/superphenix-api_internal_db_model.UserOrganization"
                    }
                },
                "users": {
                    "type": "array",
        ...
        "superphenix-api_internal_db_model.Product": {
            "type": "object",
            "properties": {
                "codeAZ": {
                    "type": "string"
                ...
                "productType": {
                    "$ref": "#/definitions/superphenix-api_internal_db_model.ProductType"
                },
                "productTypeId": {
                    "type": "string"
                },
        ...
        "superphenix-api_internal_db_model.ProductType": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "superphenix-api_internal_db_model.Project": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "superphenix-api_internal_db_model.User": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "superphenix-api_internal_db_model.UserOrganization": {
            "type": "object",
            "properties": {
                "groupId": {
                    "type": "string"
...
var SwaggerInfo = &swag.Spec{
	...
	Description:      "Superphenix - Build your own cloud platform with Superphenix",
