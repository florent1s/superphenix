...
The Superphenix project and its leadership embrace the following values:
...
* Commitment to the project: participate in discussions, contributions, code and documentation reviews for **3 months** or more
...
Time zones permitting, Maintainers are expected to participate in the public developer meeting when one is established. Meeting details will be published in the repository (e.g., in README or a community doc).
...
[Code of Conduct](./CODE_OF_CONDUCT.md) violations by community members will be discussed and resolved by the Maintainers.

## Security Response Team

The Maintainers will appoint a Security Response Team to handle security reports. This committee may simply consist of the Maintainers themselves.
